...
class my_naive_bayes() :
    ...
    ## examples is a nested list or dataframe of features, and classifications is a list (or Series) or true classifications
    # for each feature.
    ...
    ## examples can be a nested list of attributes, or else a Pandas dataframe.
    ...
    ## this method should take as input two lists or Series, one representing the predictions and one representing the true
